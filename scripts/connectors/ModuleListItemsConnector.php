<?php
	class ModuleListItemsConnector {
		...
		public static $TABLE_NAME = "moduleListItems";
		public static $COLUMN_ID = "id";
		public static $COLUMN_LISTID = "listId";
		...
		function __construct($mysqli) {
			...
			$this->createStatement = $mysqli->prepare("INSERT INTO " . ModuleListItemsConnector::$TABLE_NAME . "(`" . ModuleListItemsConnector::$COLUMN_LISTID . "`, `" . ModuleListItemsConnector::$COLUMN_MODULECODE . "`, `" . ModuleListItemsConnector::$COLUMN_MODULENAME . "`, `" . ModuleListItemsConnector::$COLUMN_REQUIREDGRADES . "`) VALUES(?,?,?,?)");
			...
			$this->selectAllStatement = $mysqli->prepare("SELECT * FROM `" . ModuleListItemsConnector::$TABLE_NAME . "` WHERE `" . ModuleListItemsConnector::$COLUMN_LISTID . "` = ?");
			...
			$this->deleteByListStatement = $mysqli->prepare("DELETE FROM " . ModuleListItemsConnector::$TABLE_NAME . " WHERE `" . ModuleListItemsConnector::$COLUMN_LISTID . "` = ?");
		...
		public function create($listId, $moduleCode, $moduleName, $requiredGrades) {
			$this->createStatement->bind_param("isss", $listId, $moduleCode, $moduleName, $requiredGrades);
		...
		public function selectAll($listId) {
			$this->selectAllStatement->bind_param("i", $listId);
		...
		public function deleteList($listId) {
			$this->deleteByListStatement->bind_param("i", $listId);
			if(!$this->deleteByListStatement->execute()) return false; // if the query didn't execute, return false
