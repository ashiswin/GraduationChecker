...
<html>
<head>
	<title><?php echo SITE_NAME; ?> - Manage <?php echo $_GET['pillar']; ?></title>
			...
			<div class="col-md-4 col-xs-4">
				<div class="scrollable">
					<table class="table table-hover" id="tblTracks">
						<thead style="font-size: x-large; margin: 2vh;"><a href="#" id="btnAddTrack" style="font-size: x-large; margin: 2vh;"><i class="fa fa-plus"></i> Add Track</a></thead>
