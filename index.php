...
<html>
	...
	<body>
		...
		<h1 style="text-align: center; font-size: 5em; font-family: 'Ubuntu Bold', Arial, sans-serif"><?php echo SITE_NAME; ?></h1>
		<h3 style="text-align: center; font-family: 'Martel', Times New Roman, serif; font-weight: bold">Automated graduation elgibility checking</h3>
		...
		<form action="check.php" method="post" id="frmContinue">
